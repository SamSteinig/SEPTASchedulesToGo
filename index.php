...
<title>SEPTA Mobile | Schedules To Go | Choose Your Service</title>

<body>
  <div id="m_header">
    <a href="http://www.septa.org/m/index.html" class="logo">
      <img src="http://www2.septa.org/m/images/mobile_logo.gif" alt="SEPTA" border="0"/>
    </a>
  </div>
...
<ul id="mobileBtns">
    <li>
    <a href="index.php"><span class="schedBtn"></span><span class="btnText">Schedules To Go</span></a><div class="button_last"></div>
    
    </li>
</ul>  

<p>Choose Your Service</p>  
<form action="choose-route.php" method="post">
<select name="RouteType">


<option value="Bus">Bus</option><br>
<option value="Trolley">Trolley</option><br>
<option value="RailTransit">Subway/High Speed</option><br>

</select>
<p><input type="submit" / value="Choose Route >>"></p>
</form>
...
<a href="http://www.septa.org?mobile_redirect=false">Full Site</a></div>
